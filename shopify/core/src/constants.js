...
// Ships as `lib_version` on every event. It tracks the JS SDK release, not this
// package's own version in package.json, which is why the two numbers differ.
// test_version_matches_sdk in the SDK suite keeps them in step.
